...
\usepackage[colorlinks,linkcolor=red,anchorcolor=blue,citecolor=green]{hyperref}%超链接引用，最后插入以避免问题
% 节标题格式设置
...
%       \LARGE\textbf{A Brief Summary of Statistics Minor Courses}\\\Large\heiti 清华大学统计学辅修课程知识总结\\[0.3\baselineskip]
...
\begin{titlepage}
  \thispagestyle{myheadings}\markright{Compiled using \textnormal{\hologo{XeTeX}} engine.}
  \begin{center}
      \vspace*{4cm}
{      \settowidth{\unitlength}{\Huge A Brief Summary of Statistics Minor Courses}
      \rule{\unitlength}{1.6pt}\vspace*{-\baselineskip}\vspace*{2pt}
...
% \maketitle\thispagestyle{myheadings}\markright{Compiled using \hologo{XeTeX} engine.}
