...
\subsubsection{Optimal Criterion}\label{SubSectionOptimalCriterion}
    ...
    \begin{itemize}
        ...
        Otherwise, say $\hat{\theta}$ or $\hat{g}$ biased. Def. \textbf{Bias}:
        \begin{align*}
        ...
        \end{equation}
        \item Mean Squared Error (MSE)\index{MSE (Mean Squared Error)}: Most efficient in the sense with Bias-Variance trade-off\index{Bias-Variance Trade-Off}
