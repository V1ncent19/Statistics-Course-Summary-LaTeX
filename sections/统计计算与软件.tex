...
\end{point}
    ...
    \textbf{Stationary Distribution} / equilibrium distribution / invariant distribution $ \pi_\infty $ of a markov satisfies\index{Stationary Distribution}\index{Equilibrium Distribution}\index{Invariant Distribution}
    \begin{align}
