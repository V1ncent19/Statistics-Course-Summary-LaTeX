...
\begin{point}
    Effect Model\index{Factor Effect Model}
\end{point}
...
\subsection{Fixed Effect and Random Effect}
    ...
    \begin{point}
        Fixed Effect:\index{Fixed Effect}
    \end{point}
...
\begin{point}
    Random Effect:\index{Random Effect}
\end{point}
...
\end{point}
\index{Montgomery's Method}\index{EMS@$ \mathbb{E}(MS) $}
...
\begin{enumerate}[topsep=2pt,itemsep=2pt]
    ...
    \begin{table}[H]
        ...
        \label{}
    \end{table}
    \item Now we can use $ \mathbb{E}\left( \mathrm{MS}  \right)  $ to construct correponding $ F^* $. e.g. to test $ H_0:\alpha _1=\alpha _2=\ldots =\alpha _a $, we use:
    \begin{align}
...
\begin{point}
    Crossed and Nested Factors\index{Crossed Factor}\index{Nested Factor}
\end{point}
...
\end{point}
\index{Prospective Study}\index{Retrospective Study}
...
\end{align}
    ...
    Their estimation:
\begin{itemize}[topsep=2pt,itemsep=0pt]
    \item Respective probability $ p_1,p_2 $:\index{Respective Probability}
...
\end{point}
    ...
    Statistics:
    \begin{itemize}[topsep=2pt,itemsep=0pt]
        \item \textbf{Pearson's $ \chi^2 $ Test}\index{Pearson's $ \chi^2 $ Test}:
        \begin{align}
            \chi^2_P=\sum_{i=1}^I\sum_{j=1}^J\dfrac{(O_{ij}-E_{ij})^2}{E_{ij}}\xrightarrow[]{\mathscr{L}} \chi^2_{(I-1)(J-1)}
        \end{align}
        
        
        \item \textbf{Likelihood Ratio Test}:\index{LRT (Likelihood Ratio Test)}
        \begin{align}
